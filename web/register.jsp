            ...
            <form action="adduser" method="post">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <input name="fullname" onkeypress="return isAlphaNumSpace(event);" id="name_reg" type="text" class="validate">
                        <label for="name_reg">Full Name</label>

                    </div>

                    <div class="input-field col s12">
                        <input name="email" onkeypress="return isEmail(event);" id="email_reg" type="email" class="validate">
...
<%--                <a href="adduser" id="submit_reg" class="waves-effect waves-light btn" style="background: #ee6e73 !important;">Register</a>--%>
                <button  class="waves-effect waves-light btn" style="background: #ee6e73 !important;" name="" type="submit">Register</button>
